...
#include <capture_features_and_train/GetNormals.h>
//#include <capture_features_and_train/GetFloatArrayFeature.h>
...
private:
  ...
  bool getNormalsReq(capture_features_and_train::GetNormals::Request &req, capture_features_and_train::GetNormals::Response &rsp)
  {
...
// bool getVFHReq(capture_features_and_train::GetNormals::Request &req, capture_features_and_train::GetNormals::Response &rsp)
// {
//   pcl::PointCloud<pcl::PointXYZ> *p_cloud = new pcl::PointCloud<pcl::PointXYZ>();
//   const boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > sp_pcl_cloud(p_cloud);
//   pcl::fromROSMsg(req.cluster, *p_cloud);
